                        ...
                        <div className="flex-1 mx-auto">
                            <div className="p-8">
                                ...
                                <div className="mb-4">
                                    ...
                                    <p className="text-gray-700">
                                        + 1 888 HUBSPOT <br /> (+1 888 482 7768) <br />
                                        <strong>Fax:</strong> +1 617 812 5820
                                    </p>
                                </div>
                                <div>
                                    <h5 className="text-xl font-semibold mb-2">Press / Media / Blogger Information</h5>
                                    <p className="text-gray-700">
                                        <a href="//www.hubspot.com/newsroom" rel='noreferrer' target="_blank">Visit our Newsroom for contact info</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="flex-2 mx-auto mb-2">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.610545440925!2d72.89416237466631!3d19.124733850441867!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c9ba452212f9%3A0xe8088dae3449a6f1!2sWastely%20Aqua%20(P)%20Ltd.!5e0!3m2!1sen!2sin!4v1704190130770!5m2!1sen!2sin"
